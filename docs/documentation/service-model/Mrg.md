# <img src="../../.vuepress/public/documentation/service-model/BOC/ControlBOC/CONBOC/CONB.png" style="width:50px;"> <span class="bocIcon">(MRG)</span> <br/>
...
## 1. MRG BOC 이미지
BOC 컴포넌트 목록에서 MRG BOC를 선택하여 Drag-Drop으로 화면작업 영역에 디자인합니다. <br/>
<div class="boc"> 
  <img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/MRG/MrgImg.png" style="width:150px;"> 
<div style="margin-top: 66px; margin-left: 20px; font-size: 12px;">
<span class="bocEX bocP">데이터베이스의 데이터의 병합지정이 된 대상 데이터 컬럼 부를 표시합니다.</span></div>
</div>

## 2. MRG BOC 속성
화면작업 영역에서 MRG BOC 선택 시 속성 영역에 설정이 가능한 항목에 값을 입력합니다.<br/>

<span class="font20">1)<b> 1. 기초정보</b></span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/MRG/MrgProperty(1).png"  class="boxBorder" style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/MRG/MrgProperty(2).png"  class="boxBorder" style="width:300px;"> <br/>

<span class="font18">①</span><b class="font18"> 입력 OBJECT </b> <br/>
병합 대상 데이터 Object 명을 선택합니다. 병합 처리시에 기준이 되는 데이터셋 Object를 먼저 지정하도록 합니다.<br/>
먼저 지정된 데이터셋 Object 기준으로 입력항목 컬럼을 선택할 수 있도록 되어있습니다.

<span class="font18">②</span><b class="font18"> 입력항목 </b> <br/>
입력 데이터셋 Object의 컬럼을 지정합니다. 입력 OBJECT 중 먼저 설정된 데이터셋 Object로부터 컬럼 명 속성을 가져옵니다. 추가 필요 시에는 입력 OBJECT의 값을 순서를 변경하여 추가 컬럼을 설정합니다.
...
## 3. MRG BOC 사용 예시 
<span class="font20">1) 2개의 데이터셋 Merge 사용 예</span> <br/>
SEL BOC을 2개를 생성하여 조회한 데이터들을 MRG BOC에서 입력 OBJECT로 받아와 조회할 컬럼들을 등록하여 병합합니다.<br/>

<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/MRG/MrgMerge(1).png"  style="width:380px;"> &emsp;&emsp;&emsp;
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/MRG/MrgProperty(2).png"  class="boxBorder" style="width:300px;"><br/>
