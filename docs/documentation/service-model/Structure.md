...
<span class="font18">(1)</span><b class="font18"> Logic : 논리모델</b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;
<span class="font18">(2)</span><b class="font18"> Physical : 물리 모델</b> <br/>
...
<!-- Remark -->
::: tip <Badge type="tip" text="Remark" vertical="middle" /> 
- <span class="spanBtnS">Build List</span> 할 때 빌드 서비스의 Count가 너무 많이 실행하면 서버에 부담을 줄 수가 있습니다. 빌드는 실행 내용을 선택된 서비스별로 소스 생성/ 컴파일/ 배치를 실행합니다.
...
<span class="font18">(1)</span><b class="font18"> Service BOC</b> <br/>
...
<span class="font18">(1)</span><b class="font18"> 메뉴 추가</b> <br/>
...
<span class="font18">(2)</span><b class="font18"> 서비스 추가</b> <br/>
추가하고자 하는 업무 메뉴를 선택한 후 오른쪽 마우스를 클릭하면 Context Menu가 활성화됩니다.<br/>
...
<span class="font18">(3)</span><b class="font18"> 삭제</b> <br/>
...
<span class="font18">(4)</span><b class="font18"> 공통메뉴 추가</b> <br/>
...
<span class="font18">(1)</span><b class="font18"> MENU정보</b> <br/>

<span class="font18">①</span><b class="font18"> MENU ID </b><br/>
해당 메뉴의 고유 번호입니다.

<span class="font18">(2)</span><b class="font18"> 기초정보</b> <br/>

<span class="font18">①</span><b class="font18"> LABEL</b> <br/>
해당 메뉴의 이름을 입력합니다.
...
<span class="font18">(3)</span><b class="font18"> CLASS정보</b> <br/>

<span class="font18">①</span><b class="font18"> PACKAGE명</b> <br/>
&lt;SYSID&gt;는 별도로 해당 프로젝트명을 설정할 경우 &lt;SYSID&gt; 태그 안에 해당 프로젝트명을 넣어 설정하고 그 이외에는 &lt;DEFAULT&gt;로 설정됩니다.<br>

<span class="font18">②</span><b class="font18"> CLASS명</b> <br/>
...
<span class="font18">(4)</span><b class="font18"> JSP정보</b> <br/>
...
<span class="font18">(1)</span><b class="font18"> 메뉴에서 마우스 오른쪽 버튼을 클릭했을 때</b> <br/>
...
<span class="font18">②</span><b class="font18"> 서비스 ID</b> <br/>
...
:::
<!-- -->
<span class="font18">③</span><b class="font18"> ALIAS</b> <br/>
...
<span class="font18">③</span><b class="font18"> METHOD명</b> <br/>
해당 서비스의 메소드를 입력합니다.
...
<span class="font18">(5)</span><b class="font18"> 처리유형</b> <br/>
해당 서비스의 출력유형이 JSP일 때 설정이 되어 있는 JSP 파일로 처리 결과를 Forwarding합니다. <br/>
...
<span class="font18">(6)</span><b class="font18"> 최종작업정보</b> <br/>
