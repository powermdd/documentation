...
<div class="boc"> 
  <img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelBoc.png" style="width:150px;"> 
<div style="margin-top: 38px; margin-left: 20px; font-size: 12px;">
<span class="bocEX bocY2" style="margin-bottom: 14px;">데이터베이스의 데이터를 삭제하기 위한 조건 컬럼 부를 표시합니다. 
...
## 3. DEL BOC 사용 예시 
<span class="font20">1) 조건항목 속성의 입력 예</span> <br/>

<span class="font18">① 우측 속성에 조건항목을 선택해서 나오는 <span class="spanBtn">...</span> 버튼을 클릭합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelWhere(1).png" class="boxBorder" style="width:300px;"> <br/>

<span class="font18">② 입력 컬럼 입력창에 삭제 조건인 컬럼을 더블클릭하여 설정합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelWhere(2).png"   style="width:600px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelColumn(1).png"  style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelColumn(2).png"  style="width:150px;"> <br/>

<span class="font18">② M-Column 추가</span> <br/>
1개 이상의 다중 컬럼들을 추가합니다. 컬럼을 등록할 때 키보드에 있는 Enter 키 또는 “,” 로 구분해서 입력합니다. <br/>

<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelColumn(3).png"  style="width:300px;"> &emsp;&emsp;&emsp;
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelColumn(4).png"  style="width:150px;"><br/>

<span class="font20">3) Delete Query 컬럼의 계산식 입력 예</span> <br/>

<span class="font18">① 데이터 입력 및 변경할 컬럼을 선택합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelQuery(1).png" style="width:150px;"> <br/>

<span class="font18">② 우측 속성에 계산식을 선택해서 나오는 <span class="spanBtn">...</span> 버튼을 클릭합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelQuery(2).png" class="boxBorder" style="width:300px;"> <br/>

<span class="font18">③ 수식 입력창에서 파라미터에 넣을 값이나 수식을 입력하여 저장합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelQuery(3).png"   style="width:600px;"> <br/>

<span class="font20">4) DEL 파라미터 컬럼의 SQL구문 입력</span> <br/>

<span class="font18">① 파라미터인 컬럼을 클릭합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelSql(1).png" style="width:150px;"> <br/>

<span class="font18">② 우측 속성에 SQL구문을 선택해서 나오는 <span class="spanBtn">...</span> 버튼을 클릭합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/INS/InsSql(2).png" class="boxBorder" style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/DEL/DelSql(3).png"   style="width:500px;"> <br/>
