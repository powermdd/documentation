...
<p style="background-color: rgb(216, 190, 228);">데이터베이스의 데이터를 저장하는 컬럼 부를 표시합니다.</p>
...
<img src="../../.vuepress\public\documentation\service-model\BOC\DataBaseBOC\Property.png" class="boxBorder" style="position: relative;top: 5px; width:300px;"> <br/>
