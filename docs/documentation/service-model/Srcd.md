# <img src="../../.vuepress/public/documentation/service-model/BOC/ControlBOC/CONBOC/CONB.png" style="width:50px;"> <span class="bocIcon">(SRCD)</span> <br/>
...
## 1. SRCD BOC 이미지
BOC 컴포넌트 목록에서 SRCD BOC를 선택하여 Drag-Drop으로 화면작업 영역에 디자인합니다. <br/>
<div class="boc"> 
  <img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/SRCD/SrcdImg.png" style="width:150px;"> 
</div>

## 2. SRCD BOC 속성
화면작업 영역에서 SRCD BOC 선택 시 속성 영역에 설정이 가능한 항목에 값을 입력합니다.<br/>

<span class="font20">1)<b> 1. 기초정보</b></span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/SRCD/SrcdProperty(1).png"  class="boxBorder" style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/SRCD/SrcdProperty(2).png"  class="boxBorder" style="width:300px;"> <br/>

<span class="font18">①</span><b class="font18"> NULL유효 </b> <br/>
분할대상 컬럼의 값이 Null 또는 Empty일 때 유효 처리할지를 지정합니다.

<span class="font18">②</span><b class="font18"> 대상필수COLUMN </b> <br/>
입력 레코드에서 생성되는 레코드에 추가할 컬럼을 지정합니다.

<span class="font18">③</span><b class="font18"> 분할대상COLUMN </b> <br/>
다중 레코드로 분할하기 위한 대상 컬럼을 지정합니다.

<span class="font18">④</span><b class="font18"> 분할대표COLUMN </b> <br/>
분할대표에서 지정한 대상 컬럼을 이용하여 생성되는 컬럼 명을 지정합니다.

<span class="font18">⑤</span><b class="font18"> 순번COLUMN </b> <br/>
분할되어 생성되는 레코드의 순번을 저장합니다.

<span class="font18">⑥</span><b class="font18"> 입력 OBJECT </b> <br/>
쿼리의 입력 대상이 될 Object명을 설정합니다.
...
## 3. SRCD BOC 사용 예시 
입력 데이터셋에 있는 "VARCHAR_1", "VARCHAR_2", "VARCHAR_3" 컬럼을 "USE_STOCK" 컬럼의 값으로 레코드를 재구성하는 샘플입니다.

<span class="font18">① Start BOC을 클릭하여 우측 속성 화면입력에 정보들을 입력합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/SRCD/SrcdSample(1).png"  style="width:700px;"> <br/>

<span class="font18">② SRCD BOC 우측 속성에 정보들을 입력합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/SRCD/SrcdSample(2).png"  style="width:250px;"> &emsp;&emsp;&emsp;
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/SRCD/SrcdProperty(2).png"  class="boxBorder" style="width:300px;"><br/>
