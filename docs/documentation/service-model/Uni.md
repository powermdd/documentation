...
## 1. UNI BOC 이미지
<div class="boc"> 
  <img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniBoc.png" style="width:150px;"> 
...
<span class="bocEX bocP" style="margin-bottom: 28px;">데이터베이스의 데이터를 수정 및 등록하는 컬럼 부를 표시. 수정 시 set 항목으로 사용됩니다.</span>
<span class="bocEX bocW">입력한 값에 추가 또는 값을 변경하는 컬럼 부를 표시합니다.</span></div>
</div>

## 2. UNI BOC 속성
화면작업 영역에서 UNI BOC 선택 시 속성 영역에 설정이 가능한 항목에 값을 입력합니다. <br/>


<span class="font20">1)<b> 1. 기초정보</b></span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniProperty(1).png"  class="boxBorder" style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniProperty(2).png"  class="boxBorder" style="width:300px;"> <br/>

<span class="font18">①<b> DB스키마명 </b> </span><br/>
수정 및 등록 대상인 데이터베이스 스키마를 입력합니다.

<span class="font18">②<b> 대상테이블 </b></span> <br/>
수정 및 등록 대상인 데이터베이스 테이블 정보를 입력합니다.

<span class="font18">③<b> 등록대상항목 </b></span> <br/>
등록 대상인 데이터베이스 컬럼 정보를 입력합니다.

<span class="font18">④<b> 수정대상항목 </b></span> <br/>
수정 대상인 데이터베이스 컬럼 정보를 입력합니다.

<span class="font18">⑤<b> 수정조건항목 </b></span> <br/>
수정 처리를 위해서 필요한 조건 컬럼 정보를 설정합니다.

<span class="font18">⑥<b> 입력 OBJECT </b></span> <br/>
수정 및 등록할 입력 데이터 Object 명을 입력합니다.
...
## 3. UNI BOC 사용 예시 
<span class="font20">1) 대상항목과 조건항목 속성의 입력 예</span> <br/>

<span class="font18">① 우측 속성에 대상항목 또는 조건항목을 선택해서 나오는 <span class="spanBtn">...</span> 버튼을 클릭합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniAll(1).png" class="boxBorder" style="width:300px;"> <br/>

<span class="font18">② 출력 컬럼 입력창 또는 입력 컬럼 입력창에 등록할 컬럼을 더블클릭하여 설정합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniAll(2).png"   style="width:600px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniColumn(1).png"  style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniColumn(2).png"  style="width:150px;"> <br/>

<span class="font18">② M-Column 추가</span> <br/>
1개 이상의 다중 컬럼들을 추가합니다. 컬럼을 등록할 때 키보드에 있는 Enter 키 또는 “,” 로 구분해서 입력합니다. <br/>

<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniColumn(3).png"  style="width:300px;"> &emsp;&emsp;&emsp;
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniColumn(4).png"  style="width:150px;"><br/>

<span class="font20">3) UNI 파라미터 컬럼의 SQL구문 입력</span> <br/>

<span class="font18">① 파라미터인 컬럼을 클릭합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniSql(1).png" style="width:150px;"> <br/>

<span class="font18">② 우측 속성에 SQL구문을 선택해서 나오는 <span class="spanBtn">...</span> 버튼을 클릭합니다.</span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniSql(2).png" class="boxBorder" style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/DataBaseBOC/UNI/UniSql(3).png"   style="width:500px;"> <br/>
...
<style type='text/css'>
  ...
  .bocG:after, .bocY2:after, .bocP:after, .bocW:after, .bocY:after
