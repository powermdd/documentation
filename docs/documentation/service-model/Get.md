# <img class="iconB" src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GET.png" style="width:50px;"> <span class="bocIcon">(GET)</span> <br/>
...
## 1. GET BOC 이미지
BOC 컴포넌트 목록에서 GET BOC를 선택하여 Drag-Drop으로 화면작업 영역에 디자인합니다. <br/>
<div class="boc"> 
  <img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetImg.png" style="width:150px;"> 
<div style="margin-top: 66px; margin-left: 20px; font-size: 12px;">
<span class="bocEX bocP" style="margin-bottom: 48px;">데이터베이스의 데이터의 결과집합 중 GET BOC의 조건 대상이 되는 컬럼 부를 표시합니다.</span></div>
</div>

## 2. GET BOC 속성
화면작업 영역에서 GET BOC 선택 시 속성 영역에 설정이 가능한 항목에 값을 입력합니다.<br/>

<span class="font20">1)<b> 1. 기초정보</b></span> <br/>
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetProperty(1).png"  class="boxBorder" style="width:300px;"> <br/>
...
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetProperty(2).png"  class="boxBorder" style="width:300px;"> <br/>

<span class="font18">①</span><b class="font18"> 1. 조건입력 </b> <br/>
입력 OBJECT로 지정된 데이터셋 Object에서 레코드 추출 조건을 입력합니다.

<span class="font18">②</span><b class="font18"> 2. 조건(MAX/MIN) </b> <br/>
 해당 조건은 선택항목입니다. “조건입력” 항목에 설정되어 있는 조건에 의하여 필터된 후 결과 데이터셋에서 최소/최대 값을 가진 특정 레코드만 추출합니다.
...
입력 OBJECT의 결과집합 중 GET BOC의 조건 대상이 되는 컬럼 집합을 지정합니다.
...
## 3. CVT BOC 사용 예시 
<span class="font20">1) 조건입력 사용 예</span> <br/>
처음 SEL BOC에서 조회한 데이터들을 GET BOC에서 입력 Object로 받아와 입력부에 있는 조건에 맞춰서 다시 Selection을 하게 됩니다.<br/>
DEPT_CD 컬럼의 값이 “1010”인 부서의 사용자만 가져오는 기능을 수행합니다.

<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetDefault(1).png"  style="width:350px;"> &emsp;&emsp;&emsp;
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetDefault(2).png"  class="boxBorder" style="width:300px;"><br/>

[ 테스트 결과 메시지 ]

<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetDefault(3).png"  class="boxBorder" style="width:700px;">

<span class="font20">2) MAX/MIN 기능 예</span> <br/>
1차 조건에서 필터의 결과 데이터셋 Object에서 최대값/최소값에 해당되는 레코드를 추출합니다<br/>
결과 데이터셋에서 해당 조건 중에서 USER_ID 컬럼 값 중 큰 숫자인 정보를 추출합니다.<br/>

<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetDefault(1).png"  style="width:350px;"> &emsp;&emsp;&emsp;
<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetMaxMin(2).png"  class="boxBorder" style="width:300px;"><br/>

[ 테스트 결과 메시지 ]

<img src="../../.vuepress/public/documentation/service-model/BOC/ChangeBOC/GET/GetMaxMin(3).png"  class="boxBorder" style="width:700px;">
