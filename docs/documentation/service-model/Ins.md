...
<!--INS-->
<b style="font-size: 20px">1) INS</b><br/>
DB Table에 대한 Insert 처리를 수행하는 기능 Component.
<!-- Remark -->
...
<img src="../../.vuepress\public\documentation\service-model\BOC\DataBaseBOC\INSBoc.png" style="position: relative;top: 5px; width:150px;"> <br/>
<p style="background-color: rgb(216, 190, 228);">데이터베이스의 데이터를 등록하는 컬럼 부를 표시합니다.</p>
...
<img src="../../.vuepress\public\documentation\service-model\BOC\DataBaseBOC\Property(1).png" style="position: relative;top: 5px; width:150px;"> <br/>
