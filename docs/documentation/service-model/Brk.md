...
<!--BRK-->
<b style="font-size: 20px">1) BRK</b><br/>
...
<img src="../../.vuepress\public\documentation\service-model\BOC\ControlBOC\BRKBoc.png" style="position: relative;top: 5px; width:150px;"> <br/>

<b style="font-size: 20px">(2) 속성</b><br/>
화면 작업창에서 BRK BOC 선택 시 속성 창에 설정이 가능한 항목에 값을 입력합니다. <br/>
<img src="../../.vuepress\public\documentation\service-model\BOC\ControlBOC\Property(5).png" class="boxBorder" style="position: relative;top: 5px; width:300px;"> <br/>
